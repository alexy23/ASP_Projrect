...
namespace ImageBoard.Service
{
    public class SecurityService : ISecurityService
    {
        ...
        {
            var user = _users.GetBy(username, password);
        ...
        public User CreateUser(SignupModel signupModel, bool login = true)
        {
            var user = _users.Create(signupModel.UserName, signupModel.Password, new Profile());
